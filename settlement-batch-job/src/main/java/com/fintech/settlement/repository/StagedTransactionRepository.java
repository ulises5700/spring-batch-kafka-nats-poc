 ...
 * 
 * <p>
 * Provides data access methods for the transaction staging table,
 * including batch processing support methods.
 * </p>
 */
@Repository
public interface StagedTransactionRepository extends JpaRepository<StagedTransaction, Long> {
         ...
         */
        java.util.Optional<StagedTransaction> findByTransactionId(String transactionId);
}
